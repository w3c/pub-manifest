...
- [Manifest to Internal Representation Processor](https://github.com/w3c/pub-manifest/tree/master/experiments/manifest-to-internal-processor/test.html) - Converts a publication manifest to a JSON view of the internal representation.
