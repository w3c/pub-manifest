...
- [Manifest to Internal Representation Processor #2](https://github.com/iherman/PubManifest) - Command line interface converting a publication manifest to a JSON view of the internal representation, with the source either in JSON-LD or in HTML. This tool does not (yet) have a Web interface.
